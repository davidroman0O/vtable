...
func (ds *FileTreeDataSource) SelectRange(startID, endID string) tea.Cmd {
	// For trees, range selection selects both nodes
...
// `04-tree-component/examples/basic-tree/main.go`
func main() {
	// Create the data source
	dataSource := NewFileTreeDataSource()

	// Configure the list component (trees reuse list config)
	...
	// Use default tree configuration and apply custom formatter with selection styling
