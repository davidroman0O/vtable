...
func UpdateViewportBounds(viewport ViewportState, config ViewportConfig, totalItems int) ViewportState {
...
func CalculateBoundingArea(viewport ViewportState, config ViewportConfig, totalItems int) BoundingArea {
	if totalItems == 0 {
		return BoundingArea{}
	}
	...
	boundingBefore := config.BoundingAreaBefore
	boundingAfter := config.BoundingAreaAfter
...
func UpdateViewportPosition(viewport ViewportState, config ViewportConfig, totalItems int) ViewportState {
	if totalItems == 0 {
		return viewport
	}
